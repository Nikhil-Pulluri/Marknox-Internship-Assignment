...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const k = Object.keys(config).find((k) => k === key)
  return k ? config[k] : null
}

export { RechartsPrimitive as ChartPrimitive, ChartContainer as Chart, ChartTooltip, ChartTooltipContent, ChartLegend, ChartLegendContent }
