  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white">
      <motion.div
        ...
        className="h-auto w-11/12 md:w-5/6 mt-[80px] mb-10 pb-12 p-4 pt-8 bg-[rgba(26,26,26,0)] rounded-lg shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-sm border border-[rgba(245,245,245,0.197)]"
      >
        <motion.h1
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="animate-fade-in text-center text-4xl sm:text-5xl lg:text-6xl font-bold mb-16 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"
        >
          My Works
        </motion.h1>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="space-y-6 animate-slide-up [animation-delay:200ms]">
            <Card
              project="XinRaise"
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="space-y-6 animate-slide-up [animation-delay:400ms]">
            <Card
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }} className="animate-slide-up [animation-delay:600ms]">
            <LeetCodeProfile />
          </motion.div>
        </div>
      </motion.div>
